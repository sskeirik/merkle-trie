...
//! # Limitations
//! 
//! 1. Currently, the `delete(&mut self, target_key: &[u8])` operation is unsupported.
//! 2. For implementation simplicity, values can only be set on true leaf nodes (setting values on intermediate nodes is unsupported).
